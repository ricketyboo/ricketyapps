...
use places_module::view::PlacePage;
        ...
        <Router>
            <main>
                ...
                <Routes fallback=|| "Page not found.".into_view()>
                    ...
                    // <Route path=StaticSegment("/login") view=ricketycore::auth::Login />
                ...
                // <ParentRoute path=StaticSegment("/admin") view=ricketycore::admin::AdminView>
                // // todo: add a sub nav view inside admin, and make admin view able to render itself with a "" route
                // <Route path=StaticSegment("users") view=ricketycore::admin::UserListView />
                // </ParentRoute>
                </Routes>
            </main>
        </Router>
